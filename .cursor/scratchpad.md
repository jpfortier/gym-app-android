...
- **PR image:** Generated when PR is created (DALL-E). GET /prs/{id}/image returns 404 until ready. No endpoint to trigger generation on demand; backend would need POST /prs/{id}/generate-image. App shows "Image not available" + Retry after 30s timeout.
